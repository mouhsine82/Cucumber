...
public class Login extends CommonMethods {
    ...
    @Given("open the browser and launch HRMS application")// no need of this method coz we use pre-condition Hook class
    ...
    @Then("Close the browser") // no need of this method coz we use post condition Hook class
