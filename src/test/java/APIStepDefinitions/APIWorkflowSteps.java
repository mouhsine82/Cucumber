...
//=================================================================================================
    ...
    public void the_status_code_for_creating_an_employee_is(Integer int1) {
        // argument or value int1 from feature file
    ...
    public void the_employee_id_is_stored_as_a_global_variable_to_be_used_for_other_calls(String empId) {
        ...
        // you can change the name of parameter as per your choice
    ...
    @Then("the employee data we get having id {string} must match with globally stored")
    public void the_employee_data_we_get_having_id_must_match_with_globally_stored(String empid) {
    ...
    @Then("the the retrieved data at {string} object matches with the data of created employee")
    public void the_the_retrieved_data_at_object_matches_with_the_data_of_created_employee(String empObject, DataTable dataTable) {
